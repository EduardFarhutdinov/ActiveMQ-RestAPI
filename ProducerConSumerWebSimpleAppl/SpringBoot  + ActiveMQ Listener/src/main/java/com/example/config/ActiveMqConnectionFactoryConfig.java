...
import com.example.jms.JmsReplyConsumer1d;
...
public class ActiveMqConnectionFactoryConfig {
    private static final Logger logger = Logger.getLogger(ActiveMqConnectionFactoryConfig.class);
...
//        converter.setTypeIdPropertyName("_type");
    ...
    public JmsListenerContainerFactory<?> jsaFactory(ConnectionFactory connectionFactory,
        ...
        factory.setErrorHandler(t->{logger.error("Error in listener",t);});
